<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mx-auto my-12">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex-items-center">
                                    <div class="flex">
                                        <img class="h-12 w-12 object-center object-cover rounded-full"
                                            src="{{ Storage::url($item->profile_photo_path) }}" alt="">
    ...
    @else
        <div class="mt-8">
            <p class="text-center font-bold">No se ha encontrado ningun usuario</p>
        </div>
    @endif
