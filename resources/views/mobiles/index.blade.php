<x-app-layout>
    ...
    @if ($samsung->count())
        <x-list>
            <div class="flex items-center">
                <div class="flex">
                    <img class="h-10 w-30 object-cover object-center" src="{{ asset('storage/samsung.png') }}" alt="">
                </div>
                <div class="ml-4">
    ...
    @if ($xiaomi->count())
        <x-list>
            <div class="flex items-center">
                <div class="flex">
                    <img class="h-10 w-30 object-cover object-center" src="{{ asset('storage/xiaomi.png') }}" alt="">
                </div>
                <div class="ml-4">
    ...
    @if ($huawei->count())
        <x-list>
            <div class="flex items-center">
                <div class="flex">
                    <img class="h-10 w-30 object-cover object-center" src="{{ asset('storage/huawei.png') }}" alt="">
                </div>
                <div class="ml-4">
